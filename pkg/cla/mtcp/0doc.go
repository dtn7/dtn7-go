...
//
// Because of the unidirectional design of MTCP, both MTCPServer and MTCPClient
// exists. The MTCPServer implements the ConvergenceReceiver and the MTCPClient
