...
// It has a multistep handshake and requires the implementer to do some heavy lifting.
//
...
// Endpoint IDs are serialised using their own native CBOR marshalers.
//
// # Bundle transmission
//
...
// it launches a new handler goroutine which receives and deserializes the bundle and terminates.
